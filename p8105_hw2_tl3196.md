...
Variable `trash_wheel` introduces which trash wheel the record comes
from. Variable `month, year, date` introduces the date of dumpster. The
rest variables introduce the statistical information of each dumpster.
...
`1947` to `2015`. The data includes `11` variables, they are
